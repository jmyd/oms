...
namespace wojilu {
    ...
    public class db {
        ...
        /// <param name="throughType"></param>
        /// <returns></returns>
        public List<T> findDataOther<T>( int thisId, Type throughType ) where T : IEntity {

            ObjectInfo state = new ObjectInfo( typeof( T ) );
            IList list = FindRelationOperation.FindDataOther( throughType, typeof( T ), state.Order, thisId );
            return getResults<T>( list );
        }
        ...
        /// <param name="throughType"></param>
        /// <returns></returns>
        public List<T> findDataSame<T>( Type throughType ) where T : IEntity {
            return null;
        }
