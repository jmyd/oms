...
namespace wojilu.Web.Context {
    ...
    public class MvcContextUtils {
        ...
        /// <summary>
        /// 禁止呈现的layout层级，从顶部开始，1表示禁止呈现第一个layout，2表示禁止呈现1和2这两个layout……n表示从1到n的所有layout都禁止呈现，999表示禁止呈现所有layout，0或者-1则表示呈现全部layout(如果是iframe状态，0表示所有都不呈现；要呈现全部，需要设置为-1)
        /// </summary>
        /// <returns></returns>
        public int getNoLayout() {

            return ctx.GetInt( "nolayout" );
        }
