...
namespace wojilu.Web.Mvc {
    ...
    public class MemberPath {
        ...
        /// <summary>
        /// 获取成员根路径，比如 /space/zhangsan, /group/moon 等
        /// </summary>
        /// <param name="owner"></param>
        /// <returns></returns>
        public static String getMemberPathUrl( IMember owner ) {
            if (owner == null) return "";
            if (owner.GetType().FullName.Equals( ConstString.SiteTypeFullName )) return "";
            return strUtil.Join( MemberPath.GetPath( owner.GetType().Name ), owner.Url );
        }

        /// <summary>
        /// 获取成员根路径，比如 /space/zhangsan, /group/moon 等
        /// </summary>
        /// <param name="ownerTypeName">不包括命名空间，比如site，而不是wojilu.Members.Sites.Domain.Site</param>
        /// <param name="ownerUrl"></param>
        /// <returns></returns>
        public static String getMemberPathUrl( String ownerTypeName, String ownerUrl ) {
