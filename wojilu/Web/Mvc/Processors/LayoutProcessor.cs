...
namespace wojilu.Web.Mvc.Processors {
    ...
    internal class LayoutProcessor : ProcessorBase {
        ...
        private String runCurrentLayout( ControllerBase controller, MvcContext ctx, ProcessContext context, String actionContent ) {
            ...
            //// 如果showEnd，则跳过combinePage
            //if (ctx.utils.isEnd()) {

            //    context.endMsg( controller.utils.getActionResult() );

            //}
            //else {
            //    context.setContent( HtmlCombiner.combinePage( controller.utils.getActionResult(), actionContent ) );
            //}
        ...
        private String runOtherLayout( ControllerBase controller, MvcContext ctx, ProcessContext context, String actionContent ) {
            ...
            //if (ctx.utils.isEnd()) {
            //    context.endMsg( layoutController.utils.getActionResult() );
            //}
            //else {
            //    context.setContent( HtmlCombiner.combinePage( layoutController.utils.getActionResult(), actionContent ) );
            //}
