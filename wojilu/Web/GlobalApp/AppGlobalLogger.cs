    ...
    public class AppGlobalLogger : AppGlobalHelper {
        ...
        private string getOtherLink() {
            if (isFrame()) {
                ...
                return "<div style=\"margin:10px 20px;\"><a href=\"javascript:history.back();\">" + lang.get( "returnLast" ) + "</a> <a href=\"" + app.Request.ApplicationPath + "\" style=\"margin-left:30px;\">" + lang.get( "siteHome" ) + "</a></div>";
            }
        }
