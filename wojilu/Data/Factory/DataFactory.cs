...
namespace wojilu.Data {
    ...
    public class DataFactory {
        ...
        public static void SetParameter( IDbCommand cmd, String parameterName, Object parameterValue ) {
            DbFactoryBase.Instance( cmd ).SetParameter( cmd, parameterName, parameterValue );
        }
