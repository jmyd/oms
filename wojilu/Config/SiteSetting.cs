...
namespace wojilu.Config {
    ...
    public class SiteSetting {
        ...
        /// <summary>
        /// 注册类型(三种类型1,开放注册 2,关闭注册 3,除了邀请，其他注册不允许)
        /// </summary>
        ...
        /// <summary>
        /// 用户注册之后默认安装的app。默认是home, blog, photo三种类型
        /// </summary>
        ...
        /// <summary>
        /// 是否给用户启用空间？如果禁用，则用户注册时不用输入友好url 
        /// </summary>
        public Boolean EnableUserSpace { get; set; }
