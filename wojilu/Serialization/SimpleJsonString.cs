        ...
        public static String ConvertObject( Object obj ) {
            ...
            foreach (PropertyInfo info in propertyList) {
                ...
                if ((info.PropertyType == typeof( int )) || (info.PropertyType == typeof( decimal ))) {
                    ...
                    builder.AppendFormat( "{0}:\"{1}\"", info.Name, strUtil.EncodeQuoteAndClearLine( strUtil.ConverToNotNull( propertyValue ) ) );
                }
                else {
                    Object str = ReflectionUtil.GetPropertyValue( propertyValue, "Id" );
                    builder.AppendFormat( "{0}:\"{1}\"", info.Name, strUtil.EncodeQuoteAndClearLine( strUtil.ConverToNotNull( str ) ) );
                }
                builder.Append( ", " );
            }
